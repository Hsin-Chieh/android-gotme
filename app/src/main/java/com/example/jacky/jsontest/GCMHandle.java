...
public class GCMHandle {
    ...
    public void sendMessage(final String key , final String phoneNumber , final String targetPhoneNumber){
        ...
        asyncTask = new AsyncTask<Void , Void ,  String>(){
            ...
            protected String doInBackground(Void... params) {
                ...
                bundle.putString("Message" , phoneNumber);
                if(!targetPhoneNumber.isEmpty())
                    bundle.putString("UserId" , targetPhoneNumber);
